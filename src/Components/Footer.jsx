        ...
        <div className="grid  w-[150px]">
          ...
          <div className="grid gap-3">
            <small className="text-[14px] text-white">
              haiderali@outlook.com
            </small>
            <div className="icons flex gap-4 py-[1rem]">
              <AiFillInstagram className="bg-white p-[5px] h-[35px] w-[35px] rounded-full hover:cursor-pointer text-blue-600" />
              <BsFacebook className="bg-white p-[5px] h-[35px] w-[35px] rounded-full hover:cursor-pointer text-blue-600" />
              <AiOutlineTwitter className="bg-white p-[5px] h-[35px] w-[35px] rounded-full hover:cursor-pointer text-blue-600" />
            </div>
          </div>
        </div>
      </div>
